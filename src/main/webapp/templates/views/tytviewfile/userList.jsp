...
<c:forEach items="${authenticates}" var="authenticate">
    ...
    <form action="<c:url value="/user-updateId/${authenticate.id}"/>" method="get">
    <button class="button block"><i class="fa fa-lock">Update</i>
    </button>
    </form>
    <form action="<c:url value="/user-deleteId/${authenticate.id}"/>" method="get">
    <button class="button block"><i class="fa fa-lock">Delete</i>
    </button>
    </form>
    <form action="<c:url value="/user-blockId/${authenticate.id}"/>" method="get">
    <button class="button block"><i class="fa fa-lock">Block User</i>
    </button>
    </form>
    <form action="<c:url value="/user-unBlockId/${authenticate.id}"/>" method="get">
