                        ...
                        <div class="contact-form">
                            ...
                            <form:form class="register-form" action="${pageContext.request.contextPath}createCompany"
                                ...
                                <div class="form">
                                    ...
                                    <form:errors path="town.nameTown" cssStyle="color: red"/>
                                    <form:input path="town.nameTown" type="text" placeholder="town"/>

                                    <form:errors path="town.country.nameCountry" cssStyle="color: red"/>
                                    <form:input path="town.country.nameCountry" type="text" placeholder="country"/>
