...
<table>
    ...
    <tr>
        ...
        <th>town</th>
        <th>country</th>
        <th>delete check car</th>
    </tr>
    </thead>
    <tbody>
    <c:forEach items="${busyDateList}" var="busyDate">
        <tr>
            <td>${busyDate.getDateCheck()}</td>
            <td>${busyDate.getDateReturn()}</td>
            <td>${busyDate.car.getNameCar()}</td>
            <td>${busyDate.car.getMakeCar()}</td>
            <td>${busyDate.getPriceCar()}</td>
            <td>${busyDate.car.company.getNameCompany()}</td>
